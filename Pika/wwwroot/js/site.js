...
(function () {
    ...
    const i18n = {
        tr: {
            ...
            "sec.f1t": "RBAC",
            "sec.f1d": "Erişimleri rollerle yönetin; kritik aksiyonlarda kontrolü kaybetmeyin.",
            "sec.f2t": "Denetim Kayıtları",
            "sec.f2d": "Değişiklik geçmişi ve güvenlik loglarıyla izlenebilirlik sağlayın.",
            "sec.f3t": "Gizlilik Odaklı",
            "sec.f3d": "Veri sorumluluğu ve uyum ihtiyaçları için süreçlerinizi netleştirin.",
        ...
        en: {
            ...
            "sec.f1t": "RBAC",
            "sec.f1d": "Manage permissions with roles so critical actions stay controlled.",
            "sec.f2t": "Audit Trails",
            "sec.f2d": "Enable traceability with change history and security logging.",
            "sec.f3t": "Privacy-first",
            "sec.f3d": "Clarify processes to meet governance and compliance expectations.",
