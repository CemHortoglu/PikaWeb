...
(function () {
    ...
    const i18n = {
        tr: {
            ...
            "sol.c0t": "Email Marketing",
            "sol.c0d": "Segment bazlı e-posta yolculukları ve otomasyon akışları oluşturun.",
            "sol.c1t": "SMS Campaigns",
            "sol.c1d": "Yüksek erişimli SMS kampanyaları ve tetik bazlı gönderimler yönetin.",
            "sol.c2t": "WhatsApp Messaging",
            "sol.c2d": "WhatsApp üzerinden iki yönlü ve kişiselleştirilmiş müşteri iletişimi kurun.",
            "sol.c3t": "Push Notifications",
            "sol.c3d": "Web ve mobil push bildirimlerini gerçek zamanlı olaylarla tetikleyin.",
            "sol.c4t": "In-App Messaging",
            "sol.c4d": "Uygulama içi mesajlarla kullanıcıyı doğru anda doğru içerikle yakalayın.",
            "sol.c5t": "Personalization",
            "sol.c5d": "Davranışsal verilere göre dinamik içerik ve teklif kurgusu sunun.",
            "sol.c6t": "Template Management",
            "sol.c6d": "Marka standartlarına uygun şablonları merkezi olarak yönetin.",
            "sol.c7t": "A/B Testing",
            "sol.c7d": "Kanal, içerik ve gönderim zamanında deneyler yaparak performansı optimize edin.",
            "sol.c8t": "Reporting",
            "sol.c8d": "Kampanya, kanal ve gelir katkısını tek panelde izleyin.",
            "sol.c9t": "Deliverability & Compliance",
            "sol.c9d": "Teslimat performansı, izin yönetimi ve regülasyon uyumunu yönetin.",
            "sol.c10t": "Data Management ETL",
            "sol.c10d": "Veri kaynaklarını normalize edin ve pazarlama kullanımına hazır hale getirin.",
            "sol.c11t": "Real-Time Event Processing",
            "sol.c11d": "Müşteri etkileşimlerini anlık işleyip kampanya aksiyonlarına dönüştürün.",
        ...
        en: {
            ...
            "sol.c0t": "Email Marketing",
            "sol.c0d": "Build segment-based email journeys and automation flows.",
            "sol.c1t": "SMS Campaigns",
            "sol.c1d": "Run high-reach SMS campaigns with trigger-based delivery.",
            "sol.c2t": "WhatsApp Messaging",
            "sol.c2d": "Enable two-way and personalized customer messaging on WhatsApp.",
            "sol.c3t": "Push Notifications",
            "sol.c3d": "Trigger web and mobile push notifications from real-time events.",
            "sol.c4t": "In-App Messaging",
            "sol.c4d": "Engage users in-app with contextual messaging.",
            "sol.c5t": "Personalization",
            "sol.c5d": "Serve dynamic content and offers based on behavioral data.",
            "sol.c6t": "Template Management",
            "sol.c6d": "Manage reusable templates with centralized brand governance.",
            "sol.c7t": "A/B Testing",
            "sol.c7d": "Optimize performance with channel, content, and timing experiments.",
            "sol.c8t": "Reporting",
            "sol.c8d": "Track campaign, channel, and revenue contribution in one dashboard.",
            "sol.c9t": "Deliverability & Compliance",
            "sol.c9d": "Manage inbox delivery, consent lifecycle, and regulatory compliance.",
            "sol.c10t": "Data Management ETL",
            "sol.c10d": "Normalize data sources and prepare them for activation.",
            "sol.c11t": "Real-Time Event Processing",
            "sol.c11d": "Process customer events instantly and convert them into actions.",
